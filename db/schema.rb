...
ActiveRecord::Schema.define(version: 20150729145637) do
  ...
  add_index "countries", ["the_geom"], name: "index_countries_on_the_geom", using: :btree
  ...
  add_index "projects", ["the_geom"], name: "index_projects_on_the_geom", using: :btree
  ...
  add_index "regions", ["the_geom"], name: "index_regions_on_the_geom", using: :btree
  ...
  add_index "sites", ["geographic_context_geometry"], name: "index_sites_on_geographic_context_geometry", using: :btree
